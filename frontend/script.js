    ...
    xhr.onload = function () {
        if (xhr.status >= 200 && xhr.status < 300) {
            try {
                ...
                // ... rest of your DOM update logic here
                // (all the document.getElementById and innerHTML assignments)// Rest of your code remains the same
                const now = new Date();
            ...
            <tr>
                ...
                console.error('Error parsing JSON or updating DOM:', e);
